...
class DiskResourceIT {
  ...
  void getAllDiskInfoReturnsStatusOK() {
    ...
    HttpStatus result = sendGET("http://localhost:7070/system-info/disk", DiskInfoCollection.class)
        .getStatusCode();
  ...
  void getAllDiskInfoReturnsObjectOfTypeDiskInfoDTO() {
    ...
    DiskInfoCollection result = (DiskInfoCollection) sendGET(
        "http://localhost:7070/system-info/disk", DiskInfoCollection.class).getBody();
  ...
  void getDiskInfoReturnsStatusOK() {
    HttpStatus expected = HttpStatus.OK;
    HttpStatus result = sendGET("http://localhost:7070/system-info/disk/d",
  ...
  void getDiskInfoReturnsObjectOfTypeDiskInfoDTO() {
    ...
    DiskInfoDTO result = (DiskInfoDTO) sendGET("http://localhost:7070/system-info/disk/d",
  ...
  void getDiskInfoThrows404StatusCode() {
    try {
      sendGET("http://localhost:7070/system-info/disk/no",
          DiskInfoDTO.class);
